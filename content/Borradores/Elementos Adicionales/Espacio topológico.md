Un _espacio topológico_ es un par $(X, \tau)$ donde $X$ es un conjunto y $\tau$ es una colección de subconjuntos de $X$, denominados conjuntos abiertos, que satisface las siguientes propiedades:
