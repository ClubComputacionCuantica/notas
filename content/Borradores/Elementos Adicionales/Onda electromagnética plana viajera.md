Una _onda electromagnética plana viajera_ es una solución en el vacío de las [Ecuaciones de Maxwell](../Elementos%20Adicionales/Ecuaciones%20de%20Maxwell.md), que describe la propagación de campos eléctrico y magnético oscilantes en forma de onda plana.
### Onda monocromática
...
donde:
  - $\mathbf{k}_\mathcal{l}$ es el [vector de onda](vector%20de%20onda),
  - $\vec{\epsilon}_\mathcal{l}$ es el [vector de polarización](vector%20de%20polarización), perpendicular a $\mathbf{k}_\mathcal{l}$,
