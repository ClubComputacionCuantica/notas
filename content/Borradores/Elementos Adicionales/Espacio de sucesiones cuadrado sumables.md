...
$$
 Dotado de un producto interno, este espacio es un ejemplo de _[[espacio de Hilbert]]_ sobre $\mathbb{R}$ o $\mathbb{C}$. El producto interno en $\ell^2$ se define como
$$
\langle \{a_n\}, \{b_n\} \rangle = \sum_{n=1}^{\infty} a_n b_n^*,
$$
donde $b_n^*$ denota el conjugado complejo de $b_n$. La [[Norma inducida por el producto interno|norma asociada a este producto interno]] se expresa como
$$
