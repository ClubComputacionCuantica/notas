...
$$
*Por ejemplo*
	$\epsilon_{123} = 1$, $\epsilon_{231} = 1$, $\epsilon_{312} = 1$, mientras que $\epsilon_{213} = -1$, $\epsilon_{132} = -1$, y $\epsilon_{321} = -1$. Si cualquier par de índices es igual, entonces $\epsilon_{ijk} = 0$, reflejando la propiedad de antisimetría.
