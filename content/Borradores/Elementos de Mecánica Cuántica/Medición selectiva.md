...
El resultado de una medición selectiva puede interpretarse como una aplicación de el [[Proyectores|proyector]] $\ket{\psi_n}\bra{\psi_n}$ aplicado a estado $\ket{\psi}$ para obtener el estado $\ket{\psi_n}\braket{\psi_n|\psi}$.
