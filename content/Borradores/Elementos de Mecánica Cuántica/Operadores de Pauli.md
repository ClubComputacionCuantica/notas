...
donde $[\cdot,\cdot]$ denota el [[conmutador]], $\{\cdot,\cdot\}$ el [[Anticonmutador|anticonmutador]], $\epsilon_{ijk}$ es el [[símbolo de Levi-Civita]], $\delta_{ij}$ es la delta de Kronecker, e $I$ es la matriz identidad de $2 \times 2$. #por-revisar 
...
Los operadores de Pauli son [[Operadores unitarios|unitarios]] y [[Operadores Hermitianos|Hermitianos]]. %%Proof?%%
