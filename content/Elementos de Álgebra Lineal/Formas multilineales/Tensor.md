...
- $T_0^1(V) = V$
- $T_1^0(V) = V^*$
- $T_0^0(V) = \mathbb{F}$ (por convención, un _tensor de orden 0_).

[^referencia]: R. Abraham, J.E. Marsden, T. Ratiu - *Manifolds, Tensor Analysis, and Applications*

#algebra-lineal #pendiente 