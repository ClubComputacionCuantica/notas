Dos vectores $\mathbf{u}$ y $\mathbf{v}$ en un [espacio vectorial](Espacio%20vectorial.md) $V$ sobre $\mathbb{R}$ o $\mathbb{C}$ se dicen _ortogonales_ si su [producto interno](../Producto%20interno.md) es cero:
$$
...
$$
donde la norma es la [norma inducida por el producto interno](Norma%20inducida%20por%20el%20producto%20interno.md). Esto equivale a:
$$
