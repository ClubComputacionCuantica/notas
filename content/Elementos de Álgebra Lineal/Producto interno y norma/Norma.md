Una _norma_ en un [espacio vectorial](../Fundamentos/Espacio%20vectorial.md) $V$ sobre un campo $\mathbb{F}$ es una función $\| \cdot \| : V \rightarrow \mathbb{R}$ que asigna a cada vector $\mathbf{v} \in V$ un número real no negativo $\| \mathbf{v} \|$, y que satisface las siguientes propiedades:
