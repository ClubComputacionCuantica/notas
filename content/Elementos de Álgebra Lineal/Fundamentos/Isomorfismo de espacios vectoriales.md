...
T: V \to W
$$
que es [[Operadores lineales|lineal]] y [[Función biyectiva|biyectiva]].

Si existe tal función, se dice que los espacios $V$ y $W$ son _isomorfos_, y se denota:
$$
V \cong W.
$$
...
### Propiedades
- El [[Inverso de un operador lineal|inverso]] de un isomorfismo existe y es también un isomorfismo.
