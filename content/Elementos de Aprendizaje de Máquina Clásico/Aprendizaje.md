El objetivo del aprendizaje es encontrar un modelo y parámetros correspondientes de manera que el [[Predictor]] resultante se comporte bien sobre un espacio de datos desconocido.[^1]
